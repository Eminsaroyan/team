    ...
    return (
        <div>
            <div className="flex justify-evenly items-center mt-[120px] mb-[120px]">
                ...
                <Link to="/acs" className="flex justify-center items-center border border-[#c2c3c4] bg-[#f5f6f7] no-underline text-[#000000] pt-[15px] rounded-[5px] pb-[20px] pt-[20px] hover:shadow-[0_4px_25px_rgba(0,0,0,0.2)] transition-shadow cursor-pointer duration-300">
