...
export default function SmartBusinessSlider() {
    return (
        <div className="flex">
            <div className="w-[290px] h-[400px] bg-[#4b5d6d]  h-64 flex flex-col items-center justify-around"
            ...
            >
                ...
                <button className="pt-[10px]  pb-[10px] pl-[35px] pr-[35px] text-[#ffffff]  font-bold   border-none rounded-[12px] bg-[#FF0000] text-[#ffffff]">Միանալ</button>x
            </div>
