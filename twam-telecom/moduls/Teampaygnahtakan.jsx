...
export default function Teampaygnahatakan() {
    const appStoreRating = 5.0;
    const googlePlayRating = 3.0;

    return (
        <div className="max-w-[1330px] mb-[50px] mx-auto">
            <h1 className="mb-[100px]">Team Pay</h1>
            ...
            <div className="flex">
                ...
                <div className="flex flex-col">
                    <div className="flex mb-[15px] text-[#FFFF00]">
                        ...
                        <span className="text-[20px] text-[#000000] text-center ml-[12px]">5.0</span>
                    </div>
                    ...
                    <div className="flex text-[#FFFF00]">
                        ...
                        <span className="text-[25px] text-[#000000] ml-3">3.0</span>
                    </div>
