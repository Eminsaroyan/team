    ...
    return (
        <nav className="flex items-center max-w-[1400px] pl-[160px] pr-[160px] pb-[5px] pt-[10px] shadow-[0_4px_6px_-1px_rgba(0,0,0,0.3)] relative bg-white z-50">
            ...
            <ul className='list-none flex'>
                <li>
                    <Link to="/smartphones" className="cursor-pointer px-[36px] py-0 no-underline text-[#000000]">
                        Սմարթֆոններ
                    </Link>
                </li>
                <li>
                    <Link to="/numbers" className="cursor-pointer px-[36px] py-0 no-underline text-[#000000]">
                        Համարներ
                    </Link>
                </li>
                <li>
                        ...
                        <ul className="absolute top-full left-0 w-[200px] list-none  leading-[3] bg-[#f8f9f9] rounded-b-[12px] shadow-xl z-50 hidden group-hover:block transition-all duration-300">
                            {[
                                ...
                                >
                                    <Link
                                        to={to}
                                        className="block w-full px-[20px] py-[1px] text-[16x] text-[#2c3843] no-underline"
                                    >
                                        {name}
                                    </Link>
                                </li>
                ...
                <li>
                    <Link to="/numbers" target="_blank" className="cursor-pointer px-[36px] py-0 no-underline text-[#000000]">
                        Թոփ համարներ
                    </Link>
                </li>
                <li>
                    <Link to="/offers" className="cursor-pointer px-[36px] py-0 no-underline text-[#000000]">
                        Ակցիաներ
                    </Link>
                </li>
            </ul>
